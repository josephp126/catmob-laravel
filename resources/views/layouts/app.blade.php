...
<body class="defult-home">
        ...
        <header id="sc-header" class="sc-header">
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-3">
                            <div class="logo-cat-wrap">
                                <div class="logo-part">
                                    <a href="/">
                                        <img id = "logoImg" src="{{asset('assets/images/logo.png')}}" alt="Logo">
                                    </a>
                                </div>
                            </div>
                        </div>
            ...
            <nav class="right_menu_togle hidden-md">
                ...
                <ul class="address-widget">
                    <li>
                        <i class="flaticon flaticon-call"></i>
                        <a href="tel:+(225)614-3878">Tel:  (225) 614 - 3878</a>
                    </li>
                    <li>
                        <i class="flaticon flaticon-mail"></i>
                        <a href="mailto:chris@legendaryestatesairbnb.com">chris@legendaryestatesairbnb.com</a>
                    </li>
                </ul>
    ...
    @include('pages.privacy-modal')
    @include('pages.terms-modal')  
